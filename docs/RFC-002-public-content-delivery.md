...
| 项目 | 内容 |
|---|---|
| 状态 | 部分实施：发布边界前置修复已完成，公开读取接口尚未交付 |
| 日期 | 2026-08-22 |
...
2. 增加专用 published-only Repository 与 Service，不复用管理查询的 status 参数。
3. 增加默认关闭的公开交付配置、专用 Handler 和公开 DTO。
4. 生成 OpenAPI，并加入 TypeScript 消费者冒烟测试。
