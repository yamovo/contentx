...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/github_com_yamovo_contentx_internal_services.LogoutRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/public/content/{uid}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Content type UID (allowlisted)",
                        "name": "uid",
                        "in": "path",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Filter by BCP-47 locale",
                        "name": "locale",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Illegal pagination",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "Type not allowlisted, unknown, or has no published entries",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/public/content/{uid}/{documentId}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Entry document ID (UUID)",
                        "name": "documentId",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.publicContentEntry"
                        },
                        "headers": {
                            "Cache-Control": {
                                "type": "string",
                    ...
                    "404": {
                        "description": "Type not allowlisted, unknown, unpublished, or missing entry",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "github_com_yamovo_contentx_internal_services.LogoutRequest": {
            "type": "object",
            "properties": {
                "refresh_token": {
                    "type": "string"
        ...
        "internal_handlers.publicContentEntry": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_yamovo_contentx_internal_models.JSONMap"
