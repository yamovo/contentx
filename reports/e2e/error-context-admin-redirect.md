...
- Name: smoke.spec.ts >> Public pages smoke >> unauthenticated access to /admin redirects to login with redirect query
- Location: e2e\smoke.spec.ts:66:3
...
Expected pattern: /\/login\?redirect=\/admin\/articles$/
Received string:  "http://localhost:3000/admin/articles"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:3000/admin/articles"
