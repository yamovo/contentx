-- MySQL benchmark seed: 1,000 published articles.
-- Row-for-row identical to seed_postgres.sql so the cross-database comparison
-- uses the same dataset.
--
-- Usage (from host, with the benchmark stack running):
--   mysql -h127.0.0.1 -P13306 -ucontentx -p<password> contentx < seed_mysql.sql
--
